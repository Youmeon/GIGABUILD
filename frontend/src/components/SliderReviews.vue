<template>
  <div class="flex flex-col">
    ...
    <div
      ref="sliderContainer"
      class="reviews-scroll flex gap-3 overflow-x-auto scroll-smooth pb-4 sm:gap-4"
    ...
    >
      <div
        ...
        :key="review.id"
        :class="[
          'review-card flex shrink-0 flex-col gap-4 rounded-xl bg-neutral-100 p-4 sm:gap-6 sm:rounded-2xl sm:p-6 lg:p-8',
          isMobile
            ? 'max-h-[350px] w-[280px]'
